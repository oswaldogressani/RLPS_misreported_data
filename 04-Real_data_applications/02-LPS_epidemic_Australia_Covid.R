...
pdf(file="Figure5_Covid19_AUS_Incidence.pdf", width = 12, height = 6)
plot(as.incidence(Ot))
dev.off()

if(delay_struct=="oneday") {
  pdf(file = "Figure5_Covid19_AUS_oneday.pdf",
      width = 12,
      height = 6)
} else if (delay_struct == "twoday") {
  pdf(file = "Figure5_Covid19_AUS_twoday.pdf",
      width = 12,
      height = 6)
}
