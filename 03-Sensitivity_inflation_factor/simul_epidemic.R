...
#                   underreporting and delay (Azmon et al. 2013)               #    
...
# the delay structure (delay) and the true delay probabilities (pij). The 
# underlying smooth function of the reproduction number is taken to be 
# R(t) = exp(cos(t/13)). The function also allows for a seed to be able to
# reproduce the simulated data.
...
# seed  --> A seed to reproduce the generated numbers
