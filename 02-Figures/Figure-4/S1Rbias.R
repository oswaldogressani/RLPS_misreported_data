...
#     Assessing the effect of the multiplication factor in Scenario 1          #
...
S1Rbias <- function(rho = 0.2, rhotilde = 0.2, S=20, seedval = 1455){
...
# True rho = 0.2
S1_0202 <- S1Rbias(rho = 0.2, rhotilde = 0.2, S = 20)
S1_0204 <- S1Rbias(rho = 0.2, rhotilde = 0.4, S = 20)
S1_0206 <- S1Rbias(rho = 0.2, rhotilde = 0.6, S = 20)
S1_0208 <- S1Rbias(rho = 0.2, rhotilde = 0.8, S = 20)
S1_021  <- S1Rbias(rho = 0.2, rhotilde = 1.0, S = 20)

# True rho = 0.4
S1_0402 <- S1Rbias(rho = 0.4, rhotilde = 0.2, S = 20)
S1_0404 <- S1Rbias(rho = 0.4, rhotilde = 0.4, S = 20)
S1_0406 <- S1Rbias(rho = 0.4, rhotilde = 0.6, S = 20)
S1_0408 <- S1Rbias(rho = 0.4, rhotilde = 0.8, S = 20)
S1_041  <- S1Rbias(rho = 0.4, rhotilde = 1.0, S = 20)

# True rho = 0.6
S1_0602 <- S1Rbias(rho = 0.6, rhotilde = 0.2, S = 20)
S1_0604 <- S1Rbias(rho = 0.6, rhotilde = 0.4, S = 20)
S1_0606 <- S1Rbias(rho = 0.6, rhotilde = 0.6, S = 20)
S1_0608 <- S1Rbias(rho = 0.6, rhotilde = 0.8, S = 20)
S1_061  <- S1Rbias(rho = 0.6, rhotilde = 1.0, S = 20)

# True rho = 0.8
S1_0802 <- S1Rbias(rho = 0.8, rhotilde = 0.2, S = 20)
S1_0804 <- S1Rbias(rho = 0.8, rhotilde = 0.4, S = 20)
S1_0806 <- S1Rbias(rho = 0.8, rhotilde = 0.6, S = 20)
S1_0808 <- S1Rbias(rho = 0.8, rhotilde = 0.8, S = 20)
S1_081  <- S1Rbias(rho = 0.8, rhotilde = 1.0, S = 20)

# True rho = 1
S1_102 <- S1Rbias(rho = 1, rhotilde = 0.2, S = 20)
S1_104 <- S1Rbias(rho = 1, rhotilde = 0.4, S = 20)
S1_106 <- S1Rbias(rho = 1, rhotilde = 0.6, S = 20)
S1_108 <- S1Rbias(rho = 1, rhotilde = 0.8, S = 20)
S1_11  <- S1Rbias(rho = 1, rhotilde = 1.0, S = 20)
...
#-- Populate row 1
RBiasMatrix[1,1] <- S1_0202$BiasRt
RBiasMatrix[1,2] <- S1_0204$BiasRt
RBiasMatrix[1,3] <- S1_0206$BiasRt
RBiasMatrix[1,4] <- S1_0208$BiasRt
RBiasMatrix[1,5] <- S1_021$BiasRt

#-- Populate row 2
RBiasMatrix[2,1] <- S1_0402$BiasRt
RBiasMatrix[2,2] <- S1_0404$BiasRt
RBiasMatrix[2,3] <- S1_0406$BiasRt
RBiasMatrix[2,4] <- S1_0408$BiasRt
RBiasMatrix[2,5] <- S1_041$BiasRt

#-- Populate row 3
RBiasMatrix[3,1] <- S1_0602$BiasRt
RBiasMatrix[3,2] <- S1_0604$BiasRt
RBiasMatrix[3,3] <- S1_0606$BiasRt
RBiasMatrix[3,4] <- S1_0608$BiasRt
RBiasMatrix[3,5] <- S1_061$BiasRt

#-- Populate row 4
RBiasMatrix[4,1] <- S1_0802$BiasRt
RBiasMatrix[4,2] <- S1_0804$BiasRt
RBiasMatrix[4,3] <- S1_0806$BiasRt
RBiasMatrix[4,4] <- S1_0808$BiasRt
RBiasMatrix[4,5] <- S1_081$BiasRt

#-- Populate row 5
RBiasMatrix[5,1] <- S1_102$BiasRt
RBiasMatrix[5,2] <- S1_104$BiasRt
RBiasMatrix[5,3] <- S1_106$BiasRt
RBiasMatrix[5,4] <- S1_108$BiasRt
RBiasMatrix[5,5] <- S1_11$BiasRt
...
#--- Save as pdf
pdf(file="S1RBias_rho.pdf", width = 7, height = 7)
plotheat
dev.off()

#--- Save as png
# png(file="S1RBias_rho.png", width = 700, height = 700)
# plotheat
# dev.off()

#--- Save workspace
# save.image("S1Rbias.RData")
