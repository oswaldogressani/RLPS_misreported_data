...
#                   Simulation results for Scenario 5                          #
...
scenario <- 3              # 1 = Decaying Rt; 2 = Wiggly Rt; 3 = U shaped
...
rho <- 0.70                # True reporting probability
...
if(s==43){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==46){prob_init <- rep(0.4, (dim_eta - 2))}
if(s==51){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==54){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==67){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==166){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==216){prob_init <- rep(0.45, (dim_eta - 2))}
if(s==221){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==291){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==301){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==310){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==356){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==363){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==368){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==370){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==407){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==432){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==470){prob_init <- rep(0.15, (dim_eta - 2))}
if(s==497){prob_init <- rep(0.15, (dim_eta - 2))}
...
# Save plot
pdf(file="Figure3_R_Scenario_5_twoday.pdf", width = 14, height = 5)
...
write.xlsx(round(perf_metrics,3),"Scenario5-Summary.xls")
