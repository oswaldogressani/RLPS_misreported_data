...
# Save plot
pdf(file="Figure2_R_Scenario_1_oneday.pdf", width = 24, height = 7.2)
...
write.xlsx(round(perf_metrics,3),"Scenario1-Summary.xls")

# Save workspace
save.image("Simulations-Scenario-1.RData")
