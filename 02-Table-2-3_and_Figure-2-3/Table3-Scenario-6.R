...
#                   Simulation results for Scenario 6                          #
...
set.seed(1111) #set.seed(1720)             # Seed
Ttime <- 30                # Number of days of an epidemic
rho <- 0.4                 # True reporting probability
...
# Save plot
pdf(file="Figure3_R_Scenario_6_weekend.pdf", width = 24, height = 7.2)
...
write.xlsx(round(perf_metrics,3),"Scenario6-Summary.xls")

# Save workspace
save.image("Simulations-Scenario-6.RData")
