...
# Save plot
pdf(file="Figure2_R_Scenario_2_twoday.pdf", width = 24, height = 7.2)
...
write.xlsx(round(perf_metrics,3),"Scenario2-Summary.xls")

# Save workspace
save.image("Simulations-Scenario-2.RData")
