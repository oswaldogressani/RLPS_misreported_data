...
# Save plot
pdf(file="Figure3_R_Scenario_5_twoday.pdf", width = 24, height = 7.2)
...
legend("top",col=c("deepskyblue1","deepskyblue4","darkolivegreen2"),
...
# Save workspace
save.image("Simulations-Scenario-5.RData")
