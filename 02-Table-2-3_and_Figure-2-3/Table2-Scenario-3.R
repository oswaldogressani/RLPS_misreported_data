...
# Save plot
pdf(file="Figure2_R_Scenario_3_weekend.pdf", width = 24, height = 7.2)
...
write.xlsx(round(perf_metrics,3),"Scenario3-Summary.xls")

# Save workspace
save.image("Simulations-Scenario-3.RData")
