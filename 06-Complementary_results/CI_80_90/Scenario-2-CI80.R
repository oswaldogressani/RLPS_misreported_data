...
#                   Simulation results for Scenario 2 (80% CI)                 #
...
alpha <- 20/100            # Level for credible intervals
...
colnames(perf_metrics) <- c("True","Mean","Bias","ESE","RMSE","CI80.low",
                            "CI80.up",
...
# Save plot
pdf(file="Scenario_2_CI80.pdf", width = 24, height = 7.2)
...
write.xlsx(round(perf_metrics,3),"Scenario2-CI80.xls")

# Save workspace
save.image("Scenario2-CI80.RData")
