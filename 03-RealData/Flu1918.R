...
p <- p <- c(0.233,0.359,0.198,0.103,0.053,0.027,0.014,0.007,0.003,0.002,0.001)  
kmax <- length(p)                       
...
# Save plots
pdf(file="Fig6_Incidence.pdf", width = 12, height = 6)
plot(as.incidence(Flu1918$incidence))
dev.off()


pdf(file="Fig6_Rt.pdf", width = 12, height = 6)
